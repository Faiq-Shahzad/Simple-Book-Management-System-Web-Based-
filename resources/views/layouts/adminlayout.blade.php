            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle {{ Request::is('admin/viewBooks') ? "active" :"" }} {{ Request::is('admin/addMovies') ? "active" :"" }}" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            Books
                        </a>

                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/admin/viewBooks">View Books</a>
                            <a class="dropdown-item" href="/admin/addBooks">Add Books</a>
                        </div>
                    </li>
    ...
    <footer>
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-1 col-12">
                <span>Copyrigths <i class="far fa-copyright"></i> 2021-- <a href="{{ url('/') }}">Bookplex.com</a> --- All Rights Reserved.</span>
            </div>
